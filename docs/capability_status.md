...
| Corporate advisory | End-to-end offline showcase + live public-data path | Risk register, Debate Gate, 24-signal anomaly scorecard, five industry threshold profiles, BaoStock point-in-time ratios, CNInfo audit/inquiry/penalty evidence, IQR remediation, human-signoff control, Owner/Timeline/KPI roadmap, injectable API runner |
