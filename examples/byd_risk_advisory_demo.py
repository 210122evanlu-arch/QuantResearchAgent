    ...
    return CompanyRiskProfile(
        ...
        assessments=[
            RiskAssessment(
                ...
                impact=IssueSeverity.HIGH,
                likelihood=IssueSeverity.HIGH,
                observation=(
                ...
                action_owner="CFO / 财务规划与分析负责人",
                timeline="30天建立桥接表，随后按月更新",
                kpis=["经营现金流/净利润", "存货周转天数", "自由现金流"],
                confidence=0.95,
            ),
            RiskAssessment(
                risk_id="BYD-R2",
                ...
                action_owner="销售负责人 / 战略规划负责人",
                timeline="30天完成情景基线，按月滚动复盘",
                kpis=["月度销量同比", "单车毛利", "渠道库存天数"],
                confidence=0.95,
            ),
            RiskAssessment(
                risk_id="BYD-R3",
                ...
                severity=IssueSeverity.HIGH,
                impact=IssueSeverity.HIGH,
                likelihood=IssueSeverity.MEDIUM,
                ...
                action_owner="资金管理负责人 / 风险管理委员会",
                timeline="60天完成敞口台账与首轮压力测试",
                kpis=["实际担保余额", "高负债率主体敞口", "逾期及代偿金额"],
                confidence=0.75,
            ),
            RiskAssessment(
                risk_id="BYD-R4",
                ...
                action_owner="董事会秘书 / 内控负责人",
                timeline="90天完成价格对标并纳入季度审议",
                kpis=["实际发生额/预计额", "关联方集中度", "价格偏离率"],
                confidence=0.85,
            ),
            RiskAssessment(
                risk_id="BYD-R5",
                ...
                action_owner="首席合规官 / 海外业务负责人",
                timeline="30天完成情景树，90天完成连续性演练",
                kpis=["受限业务收入占比", "关键供应替代覆盖率", "重大合规事件数"],
                confidence=0.8,
            ),
            RiskAssessment(
                risk_id="BYD-R6",
                ...
                action_owner="CTO / 基础设施投资负责人",
                timeline="90天建立区域级投后评价机制",
                kpis=["闪充站投运达成率", "单站利用率", "预计投资回收期"],
                confidence=0.75,
            ),
        ],
        resilience_factors=[
